label floor1_stairs:
    ...
    $ add_object_to_scene("Teleport_Basement_Pool", {"type":3, "text" : t_("ЛЕСТНИЦА В ПОДВАЛ"), "rarrow" : "arrow_down_2", "base":"Floor1_Stairs_StairsDown", "click" : "floor1_stairs_teleport", "xpos" : 635, "ypos" : 365, "zorder":9})
    ...
    if bardieLocation == "Floor1_Stairs":
        ...
        $ add_object_to_scene("Teleport_Basement_Pool", {"type":3, "text" : t_("ЛЕСТНИЦА В ПОДВАЛ"), "rarrow" : "arrow_down_2", "base":"Floor1_Stairs_StairsDown", "click" : "floor1_stairs_teleport", "xpos" : 535, "ypos" : 365, "zorder":9})


    $ add_object_to_scene("Teleport_Floor1", {"type":3, "text" : t_("ХОЛЛ"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "floor1_stairs_teleport", "xpos" : 960, "ypos" : 956, "zorder":11})

    $ add_object_to_scene("Teleport_Floor2_Stairs", {"type":3, "text" : t_("ЛЕСТНИЦА ВВЕРХ"), "rarrow" : "arrow_up_2", "base":"Floor1_Stairs_StairsUp", "click" : "floor1_stairs_teleport", "xpos" : 857, "ypos" : 250, "zorder":9})
    return
