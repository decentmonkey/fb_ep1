    ...
    if obj_name == "Teleport_Building":
        ...
        if obj_data["action"] == "w":
            ...
            if gameStage >= 2:
                ...
                return
            call change_scene("steve_office_secretary", "Fade_long", "snd_lift") from _call_change_scene_255
            return
    return
label street_steve_office_environment(obj_name, obj_data):
    if obj_name == "Driver":
        if obj_data["action"] == "l":
            call monica_looking_to_fred1() from _call_monica_looking_to_fred1_9
            return
        if obj_data["action"] == "t":
            if catchSteveInProgress == True:
                ...
                return
            call get_to_drive_dialogue() from _call_get_to_drive_dialogue_11
            return
    return
