...
label cloth_shop_view1_teleport(obj_name, obj_data):
    if obj_name == "Teleport_View2":
        call change_scene("cloth_shop_view2") from _call_change_scene_109
        return
    if obj_name == "Teleport_Dressing_Room":
        ...
        if obj_data["action"] == "w":
            call change_scene("cloth_shop_dressing_room") from _call_change_scene_110
            return
    if obj_name == "Teleport_Cashier":
        if obj_data["action"] == "l":
            ...
            return
        if obj_data["action"] == "w":
            call change_scene("cloth_shop_cashier") from _call_change_scene_111
    if obj_name == "Teleport_Street_Cloth_Shop":
        ...
        if dickBuyDressInProgress == True and dickDressBrought == False:
            ...
            return
        call change_scene("street_cloth_shop", "Fade_long") from _call_change_scene_112
        return
    return
...
label cloth_shop_view1_environment(obj_name, obj_data):
    ...
    if obj_name == "Cloth2":
        ...
        if obj_data["action"] == "w":
            ...
            call clothShopCheckFinalFitting() from _call_clothShopCheckFinalFitting
            return
        return
    if obj_name == "Cloth3":
...
label cloth_shop_view2_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Cloth_Shop_View1":
        call change_scene("cloth_shop_view1") from _call_change_scene_113
        return
    if obj_name == "Teleport_Cashier":
        call change_scene("cloth_shop_cashier") from _call_change_scene_114
        return
    return
label cloth_shop_view2_environment(obj_name, obj_data):
    ...
    if obj_name == "Cloth4":
        ...
        if obj_data["action"] == "w":
            ...
            call clothShopCheckFinalFitting() from _call_clothShopCheckFinalFitting_1
            return
        return
    if obj_name == "Cloth5":
        #1365 view2 cloth5
        ...
        if obj_data["action"] == "w":
            ...
            call clothShopCheckFinalFitting() from _call_clothShopCheckFinalFitting_2
            return
        return
    if obj_name == "Cloth6":
...
label cloth_shop_cashier_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Cloth_Shop_View1":
        call change_scene("cloth_shop_view1") from _call_change_scene_115
        return
    if obj_name == "Teleport_Dressing_Room":
        call change_scene("cloth_shop_dressing_room") from _call_change_scene_116
        return
    ...
    if obj_name == "Cashier":
        ...
        if obj_data["action"] == "t":
            if clothShopCashierTalkStage == 2:
                call cashier_afterjail_day2_talk1() from _call_cashier_afterjail_day2_talk1
                return
            if clothShopCashierTalkStage == 1:
                call dress_return_cashier_talk2() from _call_dress_return_cashier_talk2
                return
            if returnDressInProgress == True:
                call dress_return_cashier_talk1() from _call_dress_return_cashier_talk1
                return
            if eveningDressFitted == True:
                if dickDressBrought == True:
                    ...
                    call clothShopCheckFinalBuyDress() from _call_clothShopCheckFinalBuyDress
                    return
                return
            img 1354
            with fade
...
label cloth_shop_dressing_room:
    ...
    if dickBuyDressInProgress == True and dickDressBrought == False:
        call cloth_shop_dressing_room_spawn1() from _call_cloth_shop_dressing_room_spawn1
    ...
    if obj_name == "Teleport_Dressing_Room2":
        ...
        if obj_data["action"] == "w":
            if dressFitInProgress == True:
                ...
                img 4287
                dick "хе-хе..."
            call change_scene("cloth_shop_dressing_room2") from _call_change_scene_117
        return
...
label cloth_shop_dressing_room2_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Dressing_Room":
        ...
        if dressFitInProgress == True and dressFitInProgressEnded == False:
            ...
            return
        call change_scene("cloth_shop_dressing_room") from _call_change_scene_118
        return
    return
    ...
    if obj_name == "Dress":
        ...
        if obj_data["action"] == "h":
            if eveningDressFitted == True:
                ...
                call refresh_scene() from _call_refresh_scene_27
                return
            if dressFitInProgressEnded == False:
                ...
                return
            call clothShopCheckFinalFittingDressInOwnDress() from _call_clothShopCheckFinalFittingDressInOwnDress
            return
    ...
    if obj_name == "Hanger":
        ...
        if obj_data["action"] == "h":
            if dressFitInProgress == True and dressFitOwnDressDressedOut == False:
                call clothShopCheckFinalFittingOwnDressOut() from _call_clothShopCheckFinalFittingOwnDressOut
                return
    ...
    if obj_name == "Mirror1":
        ...
        if obj_data["action"] == "h":
            if dressFitInProgress == False:
                ...
                return
            call clothShopCheckFinalFitting2() from _call_clothShopCheckFinalFitting2
            return
        return
    if obj_name == "Mirror2":
        if obj_data["action"] == "l":
        ...
        if obj_data["action"] == "h":
            if dressFitInProgress == False:
                m "Мне нечего мерять здесь... Что я вообще здесь делаю?"
                return
            call Mirror1_use_shop_dress() from _call_Mirror1_use_shop_dress
            return
        return
    if obj_name == "Pouf1":
        m "Серый пуф...
...
label Mirror2_use_shop_dress:
    if dressFitOwnDressDressedOut == False:
        ...
        return
    call clothShopCheckFinalFitting2() from _call_clothShopCheckFinalFitting2_1
    return
...
label cloth_shop_dressing_room3_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Dressing_Room":
        call clothShopCheckFinalFitting3() from _call_clothShopCheckFinalFitting3
        call change_scene("cloth_shop_dressing_room", "Fade", False) from _call_change_scene_119
        return
    return
...
label clothShopCheckFinalFittingOwnDressOut:
    if shopDressFit1Begin == True:
        ...
        music casualMusic
        $ scene_transition = "Fade"
        call refresh_scene() from _call_refresh_scene_28
        return
    if shopDressFit2Begin == True:
        ...
        music casualMusic
        $ scene_transition = "Fade"
        call refresh_scene() from _call_refresh_scene_29
        return
...
label clothShopCheckFinalFitting2:
    ...
    if shopDressFit3Begin == True:
        ...
        img 4369
        call question_helper_disable() from _call_question_helper_disable_3
        ...
        call change_scene("cloth_shop_dressing_room", "Fade", False) from _call_change_scene_120
        return
    $ remove_objective("cloth_shop_fit_dress")
    $ dressFitInProgress = False
    ...
    if shopDressFit1End == True:
        ...
        menu:
            "Дик! Если это лучшее что мы здесь найдем, то нам лучше уйти!":
                call bitch(1, "dick_cloth_shop_dress1") from _call_bitch_92
                img 4317
                ...
                "Давай посмотрим еще."
            "Давай посмотрим еще.":
                call bitch(-1, "dick_cloth_shop_dress1") from _call_bitch_93
    ...
    if shopDressFit2End == True:
        ...
        menu:
            "Мне ничего здесь не нравится!":
                call bitch(1, "dick_cloth_shop_dress2") from _call_bitch_94
                img 4340
                m "Дик!
                ...
                Как ты скажешь!"
            "Посмотрю еще.":
                call bitch(-1, "dick_cloth_shop_dress2") from _call_bitch_95
                img 1368
                m "Ну..."
                "Не знаю...."
                "Посмотрю еще."
...
#        $ shopDressFit3End = False
    ...
    $ scene_transition = "Fade"
    sound snd_fabric1
    call refresh_scene() from _call_refresh_scene_31
    return
...
label clothShopCheckFinalBuyDress:
    ...
    menu:
        "Общаться с продавцом грубо.":
            ...
            call bitch(2, "clothShopCashierOffended2") from _call_bitch_100
            img 1394
            with fadelong
        ...
        "Общаться с продавцом более вежливо (насколько Моника вообще умеет).":
            call bitch(-2, "clothShopCashierOffended2") from _call_bitch_101
            img 4371
            with fadelong
            if dressMonicaPaid == True:
    ...
    menu:
        "Подшутить над Диком.":
            ...
            call bitch(1, "dickClothShopOffended4") from _call_bitch_102
            img 1399
            m "Идем, Дик."
        ...
        "Взять Дика за руку и пойти.":
            music Poppers_and_Prosecco
            call bitch(-1, "dickClothShopOffended4") from _call_bitch_103
            img 4372
            m "Идем, Дик."
            m "Идем, мой кавалер."
            mt "Хи-хи."
    ...
    call dick_meeting1_after_cloth_shop_init() from _call_dick_meeting1_after_cloth_shop_init
    if dressFitOwnDressDressedOut == False:
