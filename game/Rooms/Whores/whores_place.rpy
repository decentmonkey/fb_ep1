...
label whores_place_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Street1":
        call change_scene("whores_place_street1", "Fade_long", "highheels_run2") from _call_change_scene_137
        return
    if obj_name == "Teleport_Shawarma":
        if whoresTalkStage == 0:
            call dress_return_whores_talk1() from _call_dress_return_whores_talk1
            return
        call change_scene("whores_place_shawarma", "Fade_long", "highheels_run2") from _call_change_scene_138
        return
    return
label whores_place_environment(obj_name, obj_data):
    ...
    if obj_name == "GrayMouse2":
        ...
        if obj_data["action"] == "t":
            if whoresTalkStage == 0:
                call dress_return_whores_talk1() from _call_dress_return_whores_talk1_1
                return
            if whoresTalkStage == 1:
