...
label monica_office_photostudio:
    ...
    if photostudioEmpty == True:
        ...
        if melanieAlexBeforePhotoshoot == True:
            ...
            $ add_object_to_scene("Melanie", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Melanie1", "click" : "monica_office_photostudio_environment", "actions" : "lt", "zorder":10})
            $ add_object_to_scene("AlexPhotograph", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Alex1", "click" : "monica_office_photostudio_environment", "actions" : "lt", "zorder":10, "icon_t":"/Icons/talk" + res.suffix +".png" })

        if melanieAlexAfterPhotoshoot == True:
            $ scene_image = "scene_Office_Monica_PhotoStudio_Melanie_Alex2"
            $ add_object_to_scene("Melanie", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Melanie2", "click" : "monica_office_photostudio_environment", "actions" : "lt", "zorder":10})
            $ add_object_to_scene("AlexPhotograph", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Alex2", "click" : "monica_office_photostudio_environment", "actions" : "lt", "zorder":10, "icon_t":"/Icons/talk" + res.suffix +".png" })


    $ add_object_to_scene("Box1", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Box1", "click" : "monica_office_photostudio_environment", "actions" : "l", "zorder":0 ,"b":0.15})
    $ add_object_to_scene("Boxes", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Boxes", "click" : "monica_office_photostudio_environment", "actions" : "l", "zorder":0 ,"b":0.15})
    $ add_object_to_scene("Cloth", {"type" : 2, "base" : "Office_Monica_PhotoStudio_Cloth", "click" : "monica_office_photostudio_environment", "actions" : "l", "zorder":0})
    $ add_object_to_scene("SpotLight1", {"type" : 2, "base" : "Office_Monica_PhotoStudio_SpotLight1", "click" : "monica_office_photostudio_environment", "actions" : "l", "zorder":1 ,"b":0.15})
    $ add_object_to_scene("SpotLight2", {"type" : 2, "base" : "Office_Monica_PhotoStudio_SpotLight2", "click" : "monica_office_photostudio_environment", "actions" : "l", "zorder":1 ,"b":0.15})
    $ add_object_to_scene("SpotLight3", {"type" : 2, "base" : "Office_Monica_PhotoStudio_SpotLight3", "click" : "monica_office_photostudio_environment", "actions" : "l", "zorder":0 ,"b":0.15})
...
label monica_office_photostudio_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Monica_Office_Secretary":
        call change_scene("monica_office_secretary") from _call_change_scene_83
        return
    return
label monica_office_photostudio_environment(obj_name, obj_data):
    if obj_name == "Melanie":
        ...
        if obj_data["action"] == "t":
            if melanieAlexBeforePhotoshoot == True:
                jump monkeys_monica_photostudio1_2
            if melanieAlexAfterPhotoshoot == True:
                call monkeys_melanie_alex_after_photoshoot1(obj_name, obj_data) from _call_monkeys_melanie_alex_after_photoshoot1
                return
    ...
    if obj_name == "AlexPhotograph":
        ...
        if obj_data["action"] == "t":
            if melanieAlexBeforePhotoshoot == True:
                jump monkeys_monica_photostudio1_2
            if melanieAlexAfterPhotoshoot == True:
                call monkeys_melanie_alex_after_photoshoot1(obj_name, obj_data) from _call_monkeys_melanie_alex_after_photoshoot1_1
                return
...
label monica_office_photostudio_autorun_monica_day_1:
    m "Ага!"
