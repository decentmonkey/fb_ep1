...
#    $ juliaLocation = "floor1" #debug
    ...
    menu:
        "Уволить кого-нибудь!":
            ...
            if juliaPunished == True and juliaMonicaForgivenessAfterPunishment == False:
                ...
                menu:
                    "Уволить Юлию.":
                        ...
                        call bitch(5, "juliaFirePlanned") from _call_bitch_126
                    ...
                    "Не увольнять Юлию.":
                        ...
                        call bitch(-5, "juliaFirePlanned") from _call_bitch_127
            ...
            menu:
                "Уволить Джейн и Тиффани.":
                    ...
                    call bitch(5, "janeTiffanyFirePlanned") from _call_bitch_128
                    img 1973
                ...
                "Дать им шанс.":
                    ...
                    img 1973
                    call bitch(-5, "janeTiffanyFirePlanned") from _call_bitch_129
            ...
            menu:
                "Уволить Фреда.":
                    ...
                    call bitch(5, "fredFirePlanned") from _call_bitch_130
                    img 1981
                ...
                "Дать ему шанс.":
                    ...
                    call bitch(-5, "fredFirePlanned") from _call_bitch_131
                    if juliaFirePlanned == True:
                        img 1964
        ...
        "Просто хороший день...":
            img 1966
            call bitch(-15, "noFiring") from _call_bitch_132
...
#    $ casualMusic = "Mandeville"
    call change_scene("bedroom1", "Fade_long") from _call_change_scene_240
