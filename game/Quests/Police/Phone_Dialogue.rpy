...
label police_phone_dialogue1(target_scene):
    music Walking_Sax2
...
label police_phone_dialogue1_happy_end:
...
label phone_dialogue_police_walk1_fred_talk:
    if fredOffendedDriveReturnDress1 == True:
