...
label marcus_cabinet_dialogue3:
    ...
    call change_scene("police_marcuscabinet", "Fade", False) from _call_change_scene_270
    return
...
label marcus_cabinet_dialogue7:
    ...
    call change_scene("police_marcuscabinet_door") from _call_change_scene_271
...
label marcus_cabinet_dialogue8:
    ...
    marcus "Увести ее."
    music Gearhead
    call jail_day1() from _call_jail_day1
    return
...
label marcus_cabinet_dialogue9:
    ...
    "Присаживайтесь."
    call refresh_scene_fade() from _call_refresh_scene_fade_200
