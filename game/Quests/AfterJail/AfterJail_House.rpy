...
label afterJailHouse_dialogue7: #bathroom
    ...
    menu:
        ...
        "Уйти.":
            $ autorun_to_object("bathroom_bath", "afterJailHouse_dialogue7")
            call change_scene("floor2") from _call_change_scene_225
            return
...
label afterJailHouse_dialogue11:
    ...
    call afterJailHouse_dialogue16() from _call_afterJailHouse_dialogue16
    return
...
label afterJailHouse_dialogue14:
    ...
    call afterJailHouse_dialogue16() from _call_afterJailHouse_dialogue16_1
    return
