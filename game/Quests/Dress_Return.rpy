...
label dress_return_drive1(target_scene):
    ...
    menu:
        "Задирать Фреда.":
            ...
            call bitch(1, "dress_return_drive1_1") from _call_bitch_76
            ...
            menu:
                "Продолжить задирать Фреда":
                    ...
                    call bitch(1, "dress_return_drive1_2") from _call_bitch_77
...
label dress_return_whores_talk1:
    menu:
        "Издеваться над проституткой!":
            ...
            call bitch(8, "dress_return_whore1") from _call_bitch_78
            img 1877
        ...
        "Пожалеть ее...":
            ...
            call bitch(-8, "dress_return_whore1") from _call_bitch_79
...
label dress_return_shawarma_talk2:
    ...
    menu:
        "О Боже! Что это за животное?!":
            ...
            img 1901
            call bitch(1, "shawarmaTraderOffended1") from _call_bitch_80
            m "Вот значит и ты животное."
            "Удивительно что ты умеешь разговаривать."
            "Кто тебя дрессировал?"

        "Отказать мягче...":
            call bitch(-1, "shawarmaTraderOffended1") from _call_bitch_81
            img 1899
...
label dress_return_drive3:
    ...
    menu:
        "Продолжить ругаться на Фреда.":
            ...
            call bitch(2, "fredOffendedDriveReturnDress1a") from _call_bitch_84
            ...
            m "..."
            imgl 1931
            call bitch(2, "fredOffendedDriveReturnDress1b") from _call_bitch_85
            m "Ты огурец!"
            fred "..."
            imgl 1932
            ...
            imgl 1933
            with fadelong
            call bitch(2, "fredOffendedDriveReturnDress1c") from _call_bitch_90
