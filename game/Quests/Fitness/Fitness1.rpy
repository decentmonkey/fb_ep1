...
label fitness1_stephanie_rebecca_talk1:
    ...
    menu:
        "Все было потрясающе.":
            ...
            call bitch(-1, "fitness_dick1") from _call_bitch_133
            "Все было на высоте."
        ...
        "Дик идиот!":
            ...
            call bitch(1, "fitness_dick1") from _call_bitch_134
    ...
    menu:
        "Стефани, ты ведь не провинциалка?":
            ...
            call bitch(1, "fitness_stephanie1") from _call_bitch_135
    ...
    call refresh_scene() from _call_refresh_scene_41
    return
...
label fitness1_trainer_talk2:
    ...
    menu:
        "Отшить грубо!":
            ...
            call bitch(1, "fitness_trainer1") from _call_bitch_136
            "Обезъяна."
            img 1647
            fitness_instructor "..."
        "Сказать НЕТ...":
...
label fitness1_change_cloth2:
    ...
    call stephanie_fitness_looking_monica() from _call_stephanie_fitness_looking_monica
    sound snd_fabric1
    img 1648
    with fadelong
    mt "Я готова!!"
