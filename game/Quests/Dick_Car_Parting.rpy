...
label dick_meeting1_car_parting2:
    ...
    call get_into_car() from _call_get_into_car_1
    ...
    menu:
        "Выбросить его прямо здесь...":
            sound snd_car_engine
            call bitch(5, "dickCarKickedOut") from _call_bitch_108
            ...
            call change_scene("street_cloth_shop", "Fade_long", "snd_car_engine") from _call_change_scene_161
        "Отвезти к офису...":
            sound snd_car_engine
            call bitch(-2, "dickCarKickedOut") from _call_bitch_109
            img 1439
            m "Дик, ты правда думаешь что я буду тратить время чтобы отвозить тебя домой?"
            img 1438
            dick "Дорогая, я бы тебе показал где я живу и..."
            ...
            call change_scene("street_dick_office", "Fade_long", "snd_car_engine") from _call_change_scene_162
    return
...
label dick_meeting1_car_parting4_fred_dialogue(target_scene):
    ...
    menu:
        "Дик жирный урод!":
            ...
            call bitch(2, "dickMonicaSaidToFredOffend") from _call_bitch_110
        ...
        "Дик облажался, но он старался...":
            sound snd_car_engine
            call bitch(-2, "dickMonicaSaidToFredOffend") from _call_bitch_111
            m "Дурацкий вечер!"
            "Этот Дик..."
