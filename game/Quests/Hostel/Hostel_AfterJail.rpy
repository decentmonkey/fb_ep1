...
label hostelAfterJail_bathroom_dialogue2:
    ...
    if hostelBathroomStage == 1:
        ...
        call change_scene("hostel_bedroom", "Fade", "snd_walk_barefoot") from _call_change_scene_91
...
label hostelAfterJail_bedroom_sleep1:
    ...
    call clothShopTraderScene1() from _call_clothShopTraderScene1

    scene black_screen
    with Dissolve(1)
    stop music fadeout 1.0
    call textonblack_long("УТРО") from _call_textonblack_long_1
    scene black_screen
    with Dissolve(1)
    $ changeDayTime("day")
...
label hostelAfterJail_bedroom_dialogue5:
    ...
    call change_scene("hostel_bedroom3", "Fade", False) from _call_change_scene_92
    return
...
label hostelAfterJail_bedroom_dialogue7:
    ...
    call change_scene("hostel_street", "Fade", "snd_walk_barefoot") from _call_change_scene_93
    return
...
#    $ renpy.music.stop("rain")
    ...
    $ cloth = "Whore"
    $ cloth_type = "Whore"
    call change_scene("hostel_edge_1_a", "Fade_long", False) from _call_change_scene_94
    return
...
#    $ renpy.music.stop("rain")
    ...
    call change_scene("whores_place") from _call_change_scene_95
    return
