...
#    music Groove2_85
    ...
    menu:
        ...
        "Мне не нужны ваши комплименты!":
            call gas_saleswoman_dialogue2_getout1() from _call_gas_saleswoman_dialogue2_getout1
            return
    ...
    menu:
        ...
        "Предложение работы от первого встречного?":
            call gas_saleswoman_dialogue2_getout2() from _call_gas_saleswoman_dialogue2_getout2
            return
    saleswoman "Спасибо..."
    ...
    menu:
        ...
        "Мне он тоже нравится, но я вам не верю!":
            call gas_saleswoman_dialogue2_getout3() from _call_gas_saleswoman_dialogue2_getout3
            return
...
#        "пятно на полу"
    ...
    menu:
        ...
        "У меня красивые трусики и они нравятся моему парню!":
            call gas_saleswoman_dialogue2_getout4() from _call_gas_saleswoman_dialogue2_getout4
            return
    ...
    menu:
        ...
        "Я умная и не поведусь на этот блеф!":
            call gas_saleswoman_dialogue2_getout5() from _call_gas_saleswoman_dialogue2_getout5
            return
    ...
    call change_scene("gas_station_view_door_scene1", "Fade_long", "snd_door_close1") from _call_change_scene_177
    return
    ...
    if obj_name == "Door":
        ...
        if obj_data["action"] == "h":
            if gas_saleswoman_dialogue2_flag1_viewed == False:
                fred "Юная модель ушла туда..."
                "Мне кажется она уже готова к кастингу!"
            call gas_saleswoman_dialogue2_2() from _call_gas_saleswoman_dialogue2_2
...
label gas_saleswoman_dialogue2_2:
    ...
    menu:
        ...
        "Только не так!":
            call gas_saleswoman_dialogue2_2_out() from _call_gas_saleswoman_dialogue2_2_out
            return
...
#    call GasStation_Saleswoman2_Video_Blowjob()
    ...
    menu:
        ...
        "Без сознания...":
            call gas_saleswoman_dialogue2_2_out2() from _call_gas_saleswoman_dialogue2_2_out2
            return
    ...
    call GasStation_Saleswoman2_Video_Anal() from _call_GasStation_Saleswoman2_Video_Anal
    w
    img 4653
    fred "Оооо! Кристина!"
    "Чувствуете мой опыт?"
    ...
    with fade
    w
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end
    return
...
#    music Groove2_85
    ...
    with fade
    w
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_1
    return
...
label gas_saleswoman_dialogue2_getout1:
    ...
    fred "Хорошо, юная леди.
    Мы скоро увидимся!"
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_2
    return
...
label gas_saleswoman_dialogue2_getout2:
    ...
    fred "Хорошо, юная леди.
    Мы скоро увидимся!"
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_3
    return
...
label gas_saleswoman_dialogue2_getout3:
    ...
    fred "Хорошо, юная леди.
    Мы скоро увидимся!"
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_4
    return
...
label gas_saleswoman_dialogue2_getout4:
    ...
    fred "Хорошо, юная леди.
    Мы скоро увидимся!"
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_5
    return
label gas_saleswoman_dialogue2_getout5:
    ...
    fred "Хорошо, юная леди.
    Мы скоро увидимся!"
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_6
    return
...
label gas_saleswoman_dialogue2_2_out:
    ...
    scene black_screen
    with Dissolve(2)
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_7
    return
label gas_saleswoman_dialogue2_2_out2:
    stop music fadeout 3.0
    scene black_screen
    with Dissolve(2)
    call gas_saleswoman_dialogue2_end() from _call_gas_saleswoman_dialogue2_end_8
    return
label gas_saleswoman_dialogue2_end:
    stop music fadeout 3.0
    call quest_house_monica_day2_day_init() from _call_quest_house_monica_day2_day_init
    return
