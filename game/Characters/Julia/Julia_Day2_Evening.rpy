label julia_day2_evening(obj_name, obj_data):
    ...
    if obj_data["action"] == "l":
        call floor1_monica_julia_revenge_interact_look() from _call_floor1_monica_julia_revenge_interact_look_5
        return
    if obj_data["action"] == "t":
        if monicaEated == True:
            call julia_day2_evening_monica_eated() from _call_julia_day2_evening_monica_eated
            return
