...
label floor2_julia_monica_revenge_start:
    ...
    call question_helper_enable("question_helper_hairdye") from _call_question_helper_enable_5
...
#    call miniMapAddDisabled("Street_Yard")
    ...
    call question_helper_disable() from _call_question_helper_disable_5
...
label miniMapJuliaRevengeFloor1Catch:
    call change_scene("floor1") from _call_change_scene_195
...
label floor2_julia_monica_revenge_julia_punish:
    ...
    $ miniMapSubst["Street_Yard"] = False
    call miniMapAddDisabled("Street_Yard") from _call_miniMapAddDisabled
...
label floor2_julia_monica_revenge_julia_punish2:
    ...
    call miniMapRemoveDisabled("Street_Yard") from _call_miniMapRemoveDisabled_1
    if julia_monica_revenge_undo_in_progress == False:
        m "ЮЛИЯ!
        БЫСТРО КО МНЕ!!!"
    else:
