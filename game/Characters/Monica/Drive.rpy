...
#    $ scene_transition = "Fade"
    ...
    call refresh_scene() from _call_refresh_scene_32
    return
...
label start_walk_direct():
    call change_scene(target_scene, "Fade_long", "highheels_run2") from _call_change_scene_132
    return
...
label startDriving:
    ...
    if drivingPlacePlannedArray.has_key(target_map_scene) and drivingPlacePlannedArray[target_map_scene] != False:
        ...
        call expression driveSceneToCall pass (target_scene) from _call_expression_9
...
#        return
    if dressReturnDialoguePlanned == True:
        ...
        call dress_return_drive3() from _call_dress_return_drive3
        return
    if dick_meeting1_restaurant_drive_dialogue1_planned == True:
        call dick_meeting1_restaurant_drive_dialogue1() from _call_dick_meeting1_restaurant_drive_dialogue1
        return
    ...
    if dickMeeting1Drive1DialoguePlanned == True:
        ...
        call drive_speak_monica_dick_day1_drive1() from _call_drive_speak_monica_dick_day1_drive1
        return
    return
...
label drive_speak_monica_fred_fitness(target_scene):
    ...
    menu:
        "Задирать Фреда.":
            ...
            imgl 1516
            call bitch(1, "fredOffendedDriveFitness1") from _call_bitch_104
            ...
            menu:
                "Продолжить задирать Фреда":
                    ...
                    call bitch(1, "fredOffendedDriveFitness2") from _call_bitch_105
                    "Таких как ты."
                    ...
                    menu:
                        ...
                        "Продолжить задирать Фреда":
                            ...
                            call bitch(1, "fredOffendedDriveFitness4") from _call_bitch_106
                            imgl 1518
                            ...
                            menu:
                                "Продолжить задирать Фреда":
                                    ...
                                    imgl 1518
                                    call bitch(1, "fredOffendedDriveFitness3") from _call_bitch_107
